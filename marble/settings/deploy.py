...
EMAIL_SUBJECT_PREFIX = '[Marble %s] ' % ENVIRONMENT.title()
...
# BROKER_URL = 'amqp://marble_%(ENVIRONMENT)s:%(BROKER_PASSWORD)s@%(BROKER_HOST)s/marble_%(ENVIRONMENT)s' % os.environ  # noqa
